  ...
  return (
    <div className="flex flex-col h-full bg-white relative">
      ...
      <div className="flex-1 overflow-y-auto pb-20 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        {/* Main Post */}
        <div className="px-4 py-5 border-b border-gray-100 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1">
                  <span className="font-bold text-gray-900">Jessica Smith</span>
                  <svg className="w-4 h-4 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                  </svg>
                </div>
                <span className="text-gray-500 text-sm">@jess_smith • 2h</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between pt-3 text-gray-500 border-t border-gray-100 mt-2">
        ...
        <div className="flex flex-col">
          {COMMENTS.map(comment => (
            <div key={comment.id} className="flex gap-3 px-4 py-4 border-b border-gray-50">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mt-2 px-2">
                  ...
                  <button className="text-xs font-bold text-gray-500 hover:text-black flex items-center gap-1">
                    Like <span className="font-normal text-gray-400">({comment.likes})</span>
                  </button>
                </div>
              </div>
            </div>
      ...
      {/* Comment Input */}
      <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-3 flex items-center gap-3 shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.05)]">
        <img 
